...
var init = function init(canvas_id) {
  ...
  var doc = new PDFDocument(); // console.log('%cSuccessfully initialised signature and pdf objects', 'color:green');
